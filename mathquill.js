...
(function () {
  ...
  */
  ...
  // addd custom variable

  LatexCmds.variable = P(MathCommand, function (_, super_) {
    _.ctrlSeq = '\\variable';
    _.htmlTemplate =
      // '<span class="mq-fraction mq-non-leaf">'
      // + '<span class="mq-numerator">&0</span>'
      ...
      // + '<span style="display:inline-block;width:0">&#8203;</span>'
      // + '</span>'
      `<span>&0</span><span class="mq-supsub mq-non-leaf mq-sup-only" ><span class="mq-sup"><span>&1</span></span></span>`
      ;
    // _.textTemplate = ['(', '(', ')', ')'];
    _.finalizeTree = function () {
      this.upInto = this.ends[R].upOutOf = this.ends[L];
  ...
  // var VariableCust = P(Symbol, function (_, super_) {
  //   _.init = function (ch, html) {
  //     console.log(ch, html)
  //     super_.init.call(this, ch, `<span>a</span><span class="mq-supsub mq-non-leaf mq-sup-only" ><span class="mq-sup"><span>b, c</span></span></span>`);
  //   };
  // });
  // LatexCmds.variable = //Elsevier and 9573-13
  //   LatexCmds.variable = //AMS and LaTeX 
  //   bind(VariableCust, '\\variable');
